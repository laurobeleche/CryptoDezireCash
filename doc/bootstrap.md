...
Normally the Crypto Dezire Cash client will download the transaction and network information, called the blockchain, from the network by syncing with the other clients. This process can take quite some time as the [Crypto Dezire Cash blockchain](https://blockchain.info/charts/blocks-size) is growing bigger and bigger for each day. Luckily there is a safe and fast way to speed up this process. We'll show you how to bootstrap your blockchain to bring your client up to speed in just a few simple steps.

### Requirements

- A fresh install of the Crypto Dezire Cash client software.
...
Exit the Crypto Dezire Cash client software if you have it running. Be sure not to have an actively used wallet in use. We are going to copy the download of the blockchain to the Crypto Dezire Cash client data directory. You should run the client software at least once so it can generate the data directory. Copy the downloaded bootstrap.dat file into the Crypto Dezire Cash data folder.

**For Windows users:**
Open explorer, and type into the address bar:

	%APPDATA%\Crypto Dezire Cash
...
Open Finder by pressing Press [shift] + [cmd] + [g] and enter:
	...
	~/Library/Application Support/Crypto Dezire Cash/
...
### Importing the blockchain
Now start the Crypto Dezire Cash client software. It should show "Importing blocks from disk" like the image below. 
