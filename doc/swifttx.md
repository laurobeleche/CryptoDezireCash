...
This mechanism has been integrated into Bitcore-Node-Crypto Dezire Cash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptodezirecash/insight-api-cryptodezirecash#web-socket-api](https://github.com/cryptodezirecash/insight-api-cryptodezirecash#web-socket-api) 
* API: [https://github.com/cryptodezirecash/insight-api-cryptodezirecash#swifttx-transactions](https://github.com/cryptodezirecash/insight-api-cryptodezirecash#swifttx-transactions) 
...
By default, the Crypto Dezire Cash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Crypto Dezire Cash Core daemon:
