...
**Currently there are issues with the 1.3.x gitian releases on MacOS version 10.13 (High Sierra), no reports of issues on older versions of MacOS.**
...
RPC Changes
---------------------
The `bip38decrypt` command has had it's parameter order changed to be more consistent with it's counterpart. The command now expects the Crypto Dezire Cash address as it's first parameter and the passphrase as it's second parameter.
