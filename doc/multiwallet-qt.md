...
In order to support loading of multiple wallets in cryptodezirecash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptodezirecash.cpp.
...
Changes to cryptodezirecash.cpp
----------------------
cryptodezirecash.cpp is the entry point into cryptodezirecash-qt, and as such, will require some minor modifications to provide hooks for
