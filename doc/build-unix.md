UNIX BUILD NOTES
====================
Some notes on how to build Crypto Dezire Cash in Unix.
...
memory available when compiling Crypto Dezire Cash Core. On systems with less, gcc can be
...
You can add the repository and install using the following commands:
    ...
    sudo add-apt-repository ppa:cryptodezirecash/cryptodezirecash
    sudo apt-get update
...
See the section "Disable-wallet mode" to build Crypto Dezire Cash Core without wallet.
...
If you want to build Crypto Dezire Cash-Qt, make sure that the required packages for Qt development
...
As mentioned above, when maintaining portability of the wallet between the standard Crypto Dezire Cash Core distributions and independently built
