...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::CDZC, nValue);
...
{
    std::string genesisblockhash = "000005b30531c8d540e58a1a85afb65ab44028cf68f0b3d299565c9d41c3778b";
