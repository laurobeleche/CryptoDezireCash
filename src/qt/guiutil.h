...
/** Utility functions used by the Crypto Dezire Cash Qt UI.
 */
namespace GUIUtil
{
...
// Render Crypto Dezire Cash addresses in monospace font
...
// Parse "cryptodezirecash:" URI into recipient object, return true on successful parsing
