...
std::list<std::string> ZCdzcControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZCdzcControlDialog::listMints;
...
void ZCdzcControlDialog::updateLabels()
{
    ...
    privacyDialog->setZCdzcControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZCdzcControlDialog::GetSelectedMints()
{
