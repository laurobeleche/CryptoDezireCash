...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Crypto Dezire Cash server stopping";
}
...
#ifdef ENABLE_WALLET
        {"cryptodezirecash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35602/\n";
}
