...
public:
    CMainParams()
    {
        ...
        nTargetTimespan = 1 * 150;               // Crypto Dezire Cash: 
        nTargetSpacing = 1 * 150;                // Crypto Dezire Cash: 
        nMaturity = 120;                        // Block maturity
        ...
        nZerocoinStartHeight = 99999999;        // Zerocoin start height
        nZerocoinStartTime = 1618696182;        // 
