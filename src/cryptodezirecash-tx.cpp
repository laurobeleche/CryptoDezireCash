...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Crypto Dezire Cash Core cryptodezirecash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptodezirecash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptodezirecash transaction") + "\n" +
                               "  cryptodezirecash-tx [options] -create [commands]   " + _("Create hex-encoded cryptodezirecash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptodezirecash transaction
