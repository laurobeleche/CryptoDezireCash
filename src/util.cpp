...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\Crypto Dezire Cash
// Windows >= Vista: C:\Users\Username\AppData\Roaming\Crypto Dezire Cash
// Mac: ~/Library/Application Support/Crypto Dezire Cash
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty cryptodezirecash.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override cryptodezirecash.conf
