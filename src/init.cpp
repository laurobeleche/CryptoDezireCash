...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    string debugCategories = "addrman, alert, bench, coindb, db, lock, rand, rpc, selectcoins, tor, mempool, net, proxy, cryptodezirecash, (obfuscation, swiftx, masternode, mnpayments, mnbudget, zero)"; // Don't translate these and qt below
    if (mode == HMM_BITCOIN_QT)
        debugCategories += ", qt";
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           // FormatParagraph(strprintf(_("Copyright (C) 2018-%i The Crypto Dezire Cash Core Developers"), COPYRIGHT_YEAR)) + "\n" + // to be used instead of previous line from 2019
           // "\n" +                                                                                                     // to be used instead of previous line from 2019
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Crypto Dezire Cash version %s (%s)\n", FormatFullVersion(), CLIENT_DATE);
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                //Crypto Dezire Cash specific: zerocoin and spork DB's
                ...
                // Crypto Dezire Cash: load previous sessions sporks if we have them.
                ...
                // Crypto Dezire Cash: recalculate Accumulator Checkpoints that failed to database properly
