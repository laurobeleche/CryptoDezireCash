...
/**
 * Crypto Dezire Cash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcdzcseed(const UniValue& params, bool fHelp);
extern UniValue getzcdzcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcdzc(const UniValue& params, bool fHelp);
extern UniValue dzcdzcstate(const UniValue& params, bool fHelp);
