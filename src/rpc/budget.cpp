...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Crypto Dezire Cash initiative\n"
            "  vote-alias         - Vote on a Crypto Dezire Cash initiative\n"
            "  vote               - Vote on a Crypto Dezire Cash initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"cryptodezirecash-address\" monthy-payment\n"
            ...
            "5. \"cryptodezirecash-address\":   (string, required) Crypto Dezire Cash address to send payments to\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://forum.cryptodezire.com/t/test-proposal\" 2 820800 \"WUHPW8qfcgfpfnLBxbhFXHcxBWs6R2J3KD\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://forum.cryptodezire.com/t/test-proposal\" 2 820800 \"WUHPW8qfcgfpfnLBxbhFXHcxBWs6R2J3KD\" 500"));
    ...
    CWalletTx wtx;
    if (!pwalletMain->GetBudgetSystemCollateralTX(wtx, budgetProposalBroadcast.GetHash(), useIX)) { // 50 CDZC collateral for proposal
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"cryptodezirecash-address\" monthy-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://forum.cryptodezire.com/t/test-proposal\" 2 820800 \"WUHPW8qfcgfpfnLBxbhFXHcxBWs6R2J3KD\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://forum.cryptodezire.com/t/test-proposal\" 2 820800 \"WUHPW8qfcgfpfnLBxbhFXHcxBWs6R2J3KD\" 500"));
...
UniValue getbudgetprojection(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"PaymentAddress\": \"xxxx\",     (string) Crypto Dezire Cash address of payment\n"
