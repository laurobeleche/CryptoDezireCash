Contributing to Crypto Dezire Cash Core
============================

The Crypto Dezire Cash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Crypto Dezire Cash Core project, and is not to be
confused with overall Crypto Dezire Cash Network Protocol consensus changes.

Whether a pull request is merged into Crypto Dezire Cash Core rests with the project merge
...
Patches that change Crypto Dezire Cash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Crypto Dezire Cash consensus, it must have been
...
The project leader is the release manager for each Crypto Dezire Cash Core release.
